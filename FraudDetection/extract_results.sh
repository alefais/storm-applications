...
do
    ...
    do
        ...
        then
            ...
            # bandwidth
            grep "\[Predictor\]\ execution" tests/output_60s/main_$nsource-1-1_-1.log | awk  -F'[, ]' '{ print $20 }' >> tests/output_60s/bandwidth_$nsource-1.txt
        ...
        then
            ...
            # bandwidth
            grep "\[Predictor\]\ execution" tests/output_60s/main_$nsource-$npred-1_-1.log | awk  -F'[, ]' '{ print $20 }' >> tests/output_60s/bandwidth_$nsource-$npred.txt
